...
export const SPEAKERS = [
  {
    ...
    avatarGradient: "linear-gradient(135deg, var(--purple), var(--magenta))",
    color: "magenta",
  },
  {
    name: "Joice Ferreira",
    ...
    avatarGradient: "linear-gradient(135deg, var(--blue), var(--cyan))",
    color: "cyan",
  },
  {
    name: "Paulo Soares",
    ...
    avatarGradient: "linear-gradient(135deg, var(--coral), var(--purple))",
    color: "coral",
  },
];
